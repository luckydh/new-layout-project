      ...
      <div class="main-box b-1-black">
        ...
        <div class="b-1-black ml-1 inner-box mb-half">
          <div class="ml-1 mt-half">
            ...
            <td style="width: 50%"><input type="text" :disabled='!currentLocation.can_generate_po || currentLocation.location !== currentLocationName' 
        ...
        <div class="mb-half">
          <tr>
            <td><Label>Default Account number</Label></td>
          <td><account-lookup inputtype="number" :disable='!currentLocation.can_generate_po' 
        v-model="currentLocation.default_tax_account" class="ml-2"/></td>
          </tr>
          </div>
        ...
        <div class="mb-half">
          <tr>
            <td><Label>Default Account number</Label></td>
          <td><account-lookup inputtype="number" :disable='!currentLocation.can_generate_po'
        v-model="currentLocation.default_freight_account" class="ml-2"/></td>
          </tr>
          </div>
...
export default {
  ...
  computed:{
    ...
    locations(){
      return this.$store.state.Location.allLocations;
    },
    currentLocationName(){
      return this.$store.state.Location.currentLocationName;
    }
  },
  methods:{
